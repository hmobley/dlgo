...
class GoDataProcessor:
    ...
    def load_go_data_orig(self, data_type='train',
                          num_samples=1000):
        index = KGSIndex(data_directory=self.data_dir)
        index.download_files()
        return load_go_data(self,data_type,num_samples)
    ...
    def load_go_data(self, data_type='train',
        ...
        for zip_name in zip_names:
            ...
            #print('zip_name: {}, data_file_name: {}'.format(zip_name,data_file_name))
            ...
            for item in sgf.main_sequence_iter():
                ...
                if color is not None:
                    ...
                    if first_move_done and point is not None:
                        ...
                        counter += 1
                    #print('{} move: {}'.format(color,move.point))
    ...
    def consolidate_games(self, data_type, samples):
        ...
        for file_name in file_names:
            ...
            print('glob.glob({}): {}'.format(base,glob.glob(base))) 
    ...
    def get_handicap(sgf):
        ...
        if sgf.get_handicap() is not None and sgf.get_handicap() != 0:
            for setup in sgf.get_root().get_setup_stones():
                for move in setup:
                    row, col = move
                    #print('black handicap stone at {}'.format(Point(row + 1, col + 1)))
